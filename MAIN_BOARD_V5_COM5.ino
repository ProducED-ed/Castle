...
void updateComet() {
  ...
  if (digitalReadExpander(6, board2)) {
    if (!clickFlag1) {
      clickFlag1 = 1;
      buttonTimer1 = millis();
      if ((cometPosition >= 25 && cometPosition <= 27) || (cometPosition >= -191 && cometPosition <= -188)) {
        CatchSnitch();
        snitchFlag = 1;
        isTrainBasket = 1;
        if (enemyFlag) {
  ...
  if (digitalReadExpander(5, board2)) {
    if (!clickFlag2) {
      clickFlag2 = 1;
      buttonTimer2 = millis();
      if ((cometPosition >= 125 && cometPosition <= 127) || (cometPosition >= -90 && cometPosition <= -88)) {
        CatchSnitch();
        snitchFlag = 1;
        isTrainBasket = 1;
        if (enemyFlag) {
  ...
  if (digitalReadExpander(5, board4)) {
    if (!clickFlag4) {
      ...
      clickFlag4 = 1;
      buttonTimer4 = millis();
      if ((cometPosition >= 94 && cometPosition <= 96) || (cometPosition >= -121 && cometPosition <= -118)) {
        CatchSnitch();
        snitchFlag = 1;
        isTrainBasket = 1;
        if (enemyFlag) {
  ...
  if (digitalReadExpander(6, board4)) {
    if (!clickFlag3) {
      clickFlag3 = 1;
      buttonTimer3 = millis();
      if ((cometPosition >= 188 && cometPosition <= 191) || (cometPosition >= -27 && cometPosition <= -24)) {
        CatchSnitch();
        snitchFlag = 1;
        isTrainBasket = 1;
        if (enemyFlag) {
