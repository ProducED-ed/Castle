// ===================================================================
// СБОРКА ДЛЯ CLC2 (Канада). База — мастер, но калибровка сервопривода
// возвращена под железо CLC2 (на CLC3 стоит DS3218 с другим упором).
// ЕДИНСТВЕННОЕ отличие от мастера — параметры boyServo. См. README.md.
// ===================================================================
