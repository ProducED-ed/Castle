// ===================================================================
// СБОРКА ДЛЯ CLC2 (Канада) — 2026-07-31
// База: мастер (все фиксы с апреля), НО калибровка сервопривода
// возвращена под железо CLC2. На CLC3 стоит DS3218 с широким
// диапазоном импульса и упором на 170°; у CLC2 серво другое и
// работает на 130° — см. коммит 9abb1fa, там прямо указано
// «do NOT OTA this hex to CLC1/CLC2».
// ЕДИНСТВЕННОЕ отличие этой сборки от мастера — параметры boyServo.
// ===================================================================
