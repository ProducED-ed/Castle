...
python3 espota.py -i 192.168.4.202 -p 3232 -f /home/pi/New/Sketches/chest/chest.ino.bin
...
Физическое устройство, Где воткнуто (по lsusb),Путь для команды (-P) у CLC2
MAIN BOARD (Mega),Напрямую в Малину (Port 1),/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.1:1.0-port0
БАШНЯ 1 owls (в хабе),"Хаб, Гнездо 1",/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.2.1:1.0-port0
БАШНЯ 2 dog  (в хабе),"Хаб, Гнездо 2",/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.2.2:1.0-port0
БАШНЯ 3 bask (в хабе),"Хаб, Гнездо 3",/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.2.3:1.0-port0
БАШНЯ 4 work (в хабе),"Хаб, Гнездо 4",/dev/serial/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.2.4:1.0-port0
(Обратите внимание: :1.2 — это сам хаб, а цифры .1, .2, .3, .4 после него — это номера гнезд).


У ОМАН CLC 1 такое расположение.
Собака: DEVPATH=/devices/platform/scb/fd500000.pcie/pci0000:00/0000:00:00.0/0000:01:00.0/usb1/1-1/1-1.2/1-1.2.1/1-1.2.1:1.0/ttyUSB1/tty/ttyUSB1
Совы:
DEVPATH=/devices/platform/scb/fd500000.pcie/pci0000:00/0000:00:00.0/0000:01:00.0/usb1/1-1/1-1.2/1-1.2.4/1-1.2.4:1.0/ttyUSB4/tty/ttyUSB4
Баскет:
DEVPATH=/devices/platform/scb/fd500000.pcie/pci0000:00/0000:00:00.0/0000:01:00.0/usb1/1-1/1-1.2/1-1.2.3/1-1.2.3:1.0/ttyUSB3/tty/ttyUSB3
Мастер:
DEVPATH=/devices/platform/scb/fd500000.pcie/pci0000:00/0000:00:00.0/0000:01:00.0/usb1/1-1/1-1.2/1-1.2.3/1-1.2.2:1.0/ttyUSB3/tty/ttyUSB2
